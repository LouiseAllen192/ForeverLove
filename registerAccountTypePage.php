            ...
            <div class="col-lg-12 text-center">
                ...
                <?php
                    if(!empty($_POST) && isset($_POST['accType']) ) {
                        ...
                        if ($_POST['accType'] == "premium6") {
                            $acc = "6 month Premium";
                            $length = 6;
                        }
                        if ($_POST['accType'] == "premium12") {
                        ...
                        if ($_POST['accType'] == "free") {
                            ...
                            if($successRegisterFree){
                                echo '<' . 'div class= "alert alert-info" role="alert" id="selectedMessage">' .
                                    '<a href="homePage.php" class="close" data-dismiss="alert" aria-label="close">&times;</a>' .
                                    'You have chosen a  ' . $acc . ' account.' .
                                    '</div>'.'<br><br><p>Enjoy your 30 day free trial.<br><br>' .
                                    'Please upgrade to a Premium account to gain unlimited access to all of our websites features.<br> This can be done in the Settings option.</p>'.
                                ...
                                <strong>Something went wrong</strong> - Account details registration was unsuccessful. Please try again
                                </div>';
                            }
                        } else {
                    ...
                    if(isset($_POST['cvv'])){
                        ...
                        if(!$successValidateCard){
                            echo '<' . 'div class="alert alert-danger">
                                <a href="registerAccountTypePage.php" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                <strong>Something went wrong</strong> - The Credit Card details you entered are not valid.
                                </div>';
                        }
                        else{
                            ...
                            if(!$successRegister){
                                ...
                                <a href="registerAccountTypePage.php" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                <strong>Card Details accepted</strong> <br><br> Account details registration was successful.<br>
