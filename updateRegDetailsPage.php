                        ...
                        <fieldset>
                            ...
                            <div class="form-group" id="dob_group">
                                ...
                                <div class="col-md-offset-4 col-sm-offset-5" id="errors">
                                    ...
                                    <span class="<?php if($errors['dob'] == 'error_over18') : ?>error<?php else : ?>hide<?php endif; ?>" id="error_regex">Over 18's Only...</span>
                                    <span class="<?php if($errors['dob'] == 'error_regex') : ?>error<?php else : ?>hide<?php endif; ?>" id="error_regex">Must be a vlid date in the following format<br> YYYY-MM-DD...</span>
                                </div>
                            </div>
