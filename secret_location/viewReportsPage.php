                    ...
                    if($reports){
                        ...
                        if($n > $perPage){
                            ...
                            <div style="margin: 20px;">
                                <ul class="pagination">
                                    <li><a href="viewReportsPage.php?pageNum=<?php echo 1; ?>">&laquo;</a></li>
                                    <?php
                                    for($i = 1; $i <= $lastPage; $i++){?>
                                        <li><a href="viewReportsPage.php?pageNum=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                        <?php
                                    }
                                    ?>
                                    <li><a href="viewReportsPage.php?pageNum=<?php echo $lastPage; ?>">&raquo;</a></li>
                                </ul>
                            </div>
                            <?php
                        }
