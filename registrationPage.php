...
<head>
    ...
    $dbvalue = array("Tag_Line"=>"I'm a cool guy", "City"=>"Dublin", "Gender"=>"Male","Seeking"=>"Female", "Intent"=>"Relationship",
        ...
        "Religion"=>"Athiest", "Marital_Status"=>"Single","Income"=>"€40k - €60k per year",
        "Has_Children"=>"No", "Wants_Children"=>"Yes", "Smoker"=>"No", "Drinker"=>"Social Drinker",
        "About__Me"=>"Dublin guy looking for a relationship. Love long walks on the beach.");
            ...
            <div class="col-lg-12 text-center">
                ...
                <form id="prefrences" method="post">
                    <fieldset class="form-group">
                        ...
                        <input type="text"  class="form-control" maxlength="256" name="TagLine" placeholder= "<?php echo ($dbvalue['Tag_Line']);?>" ><br /><br>
                    </fieldset>
                    <fieldset class="form-group">
